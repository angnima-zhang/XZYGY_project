...
export class DebugConfig extends Component {
    ...
    private applyToPlayerData(): void {
        ...
        pd.setUpgradeConfig('value', this.value_initialValue, this.value_initialPrice);
        pd.setUpgradeConfig('speed', this.speed_initialValue, this.speed_initialPrice);
        pd.setUpgradeConfig('lucky', this.lucky_initialValue, this.lucky_initialPrice);
        pd.setUpgradeConfig('critical', this.critical_initialValue, this.critical_initialPrice);
        pd.setUpgradeConfig('criticalBonus', this.criticalBonus_initialValue, this.criticalBonus_initialPrice);
        pd.setUpgradeConfig('pity', this.pity_initialValue, this.pity_initialPrice);
        pd.setUpgradeConfig('streakBonus', this.streakBonus_initialValue, this.streakBonus_initialPrice);
        pd.setUpgradeConfig('time', this.time_initialValue, this.time_initialPrice);
